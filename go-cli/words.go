...
func registerSDKWords(r *eng.Registry, client *sdk.ArulsIpSDK) {
...
func runOp(client *sdk.ArulsIpSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

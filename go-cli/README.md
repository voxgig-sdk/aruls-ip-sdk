...
AQL-driven CLI and REPL for the ArulsIp SDK. Positional arguments are
...
./aruls-ip-cli list ip_address
./aruls-ip-cli load 1 ip_address
./aruls-ip-cli load '{id:1}' ip_address

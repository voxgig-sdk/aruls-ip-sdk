...
|---|---|---|
| `ts/` | @voxgig-sdk/aruls-ip-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/aruls-ip-sdk \
      --repository voxgig-sdk/aruls-ip-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/aruls-ip-sdk` shows it, and
`npm trust revoke @voxgig-sdk/aruls-ip-sdk --id=<id>` removes it.

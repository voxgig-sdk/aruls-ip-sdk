...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ArulsIpOmni.make_runner(TEST_JSON_FILE, ArulsIpSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ArulsIpOmni.errify(err)
    end

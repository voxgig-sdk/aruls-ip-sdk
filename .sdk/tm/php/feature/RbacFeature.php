...
class ArulsIpRbacFeature extends ArulsIpBaseFeature
{
    ...
    private function _required(ArulsIpContext $ctx): ?string
    {
    ...
    private function _reject(ArulsIpContext $ctx, string $required): void
    {
    ...
    private function _track(ArulsIpContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

...
class ArulsIpTimeoutFeature extends ArulsIpBaseFeature
{
    ...
    private function _with_timeout(ArulsIpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ArulsIpContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
// ArulsIp SDK clienttrack feature
...
class ArulsIpClienttrackFeature extends ArulsIpBaseFeature
{
    ...
    public function PostConstruct(ArulsIpContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ArulsIp-SDK';

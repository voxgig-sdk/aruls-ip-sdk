...
class ArulsIpProxyFeature extends ArulsIpBaseFeature
{
    ...
    public function init(ArulsIpContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ArulsIpContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

...
class ArulsIpStreamingFeature extends ArulsIpBaseFeature
{
    ...
    private function _iterate(ArulsIpResult $result): \Generator
    {
    ...
    private function _streamable(ArulsIpContext $ctx): bool
    {

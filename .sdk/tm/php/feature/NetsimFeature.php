...
class ArulsIpNetsimFeature extends ArulsIpBaseFeature
{
    ...
    private function _simulate(ArulsIpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ArulsIpContext $ctx, array $applied): void
    {
        $client = $this->client;

...
class ArulsIpGraphql
{
    ...
    // equivalent.
    public static function body(ArulsIpContext $ctx): mixed
    {
    ...
    public static function errors(ArulsIpContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

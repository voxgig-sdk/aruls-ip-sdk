...
(0, node_test_1.describe)('IpAddressDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ip_address', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ip_address', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ArulsIpSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['ARULS_IP_TEST_IP_ADDRESS_ENTID'];
    ...
    const client = new __1.ArulsIpSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=IpAddressDirect.test.js.map
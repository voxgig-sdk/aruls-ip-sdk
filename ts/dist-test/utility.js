...
function envOverride(m) {
    if ('TRUE' === process.env.ARULS_IP_TEST_LIVE ||
        'TRUE' === process.env.ARULS_IP_TEST_OVERRIDE) {
    ...
    m.ARULS_IP_TEST_EXPLAIN = process.env.ARULS_IP_TEST_EXPLAIN || m.ARULS_IP_TEST_EXPLAIN;
    return m;
}

# ArulsIp TypeScript SDK Reference

Complete API reference for the ArulsIp TypeScript SDK.
...
#### `ArulsIpSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ArulsIpSDK` instance in test mode.
...
Return the parent `ArulsIpSDK` instance.

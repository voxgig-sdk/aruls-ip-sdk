...
describe("IpAddressDirect", function()
  it("should direct-load-ip_address", function()
    local setup = ip_address_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ip_address", setup.live and "live" or "unit")
...
function ip_address_direct_setup(mockres)

...
type Args struct {
	Entity string         `json:"entity" jsonschema:"ip_address | ipn"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ArulsIpSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "aruls-ip_list",
		Description: "List records from ArulsIp. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "aruls-ip_load",
		Description: "Load a single record from ArulsIp. " +
...
func runOp(client *sdk.ArulsIpSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ArulsIpSDK, name string) (sdk.ArulsIpEntity, error) {

# ArulsIp SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ArulsIpSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ArulsIpSDK(...) and ArulsIpSDK.test(...) become
#      ArulsIpSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "arulsip_sdk"
_SDK_CLASS = "ArulsIpSDK"

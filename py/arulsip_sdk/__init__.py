...
from arulsip_sdk.utility import register

# Load features
from arulsip_sdk.feature.base_feature import ArulsIpBaseFeature
from arulsip_sdk.features import _has_feature, _make_feature
...
class ArulsIpSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ArulsIpUtility()
        self._utility = utility

        from arulsip_sdk.config import shared_config
    ...
    def get_utility(self):
        return ArulsIpUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ArulsIpSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def IpAddress(self, data=None) -> "IpAddressEntity":
        ...
        from arulsip_sdk.entity.ip_address_entity import IpAddressEntity
        return IpAddressEntity(self, data)


    def Ipn(self, data=None) -> "IpnEntity":
        """Entity factory: client.Ipn().list() / client.Ipn().load({"id": ...})."""
        from arulsip_sdk.entity.ipn_entity import IpnEntity

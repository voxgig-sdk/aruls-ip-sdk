...
from arulsip_sdk.core.helpers import get_ctx_prop, to_map
...
class ArulsIpContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, ArulsIpResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ArulsIpError(code, msg, self)

...
The Python SDK for the ArulsIp API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.IpAddress()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/aruls-ip-sdk/releases)) or
...
```
py/
├── arulsip_sdk.py         -- Main SDK module

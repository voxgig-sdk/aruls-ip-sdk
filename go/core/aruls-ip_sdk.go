...
func (sdk *ArulsIpSDK) OptionsMap() map[string]any {
...
func (sdk *ArulsIpSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ArulsIpSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ArulsIpSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ArulsIpSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ArulsIpSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ArulsIpSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ArulsIpSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ArulsIpSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ArulsIpSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ArulsIpSDK: graphql: %s", msg)
		res["graphql"] = errors
	}

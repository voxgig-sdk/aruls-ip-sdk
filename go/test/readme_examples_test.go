...
const testSeed = `map[string]any{"entity": map[string]any{"ip_address": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ipn": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

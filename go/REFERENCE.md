# ArulsIp Golang SDK Reference

Complete API reference for the ArulsIp Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ArulsIpSDK`
...
#### `IpAddress(data map[string]any) ArulsIpEntity`

Create a new `IpAddress` entity instance. Pass `nil` for no initial data.

#### `Ipn(data map[string]any) ArulsIpEntity`

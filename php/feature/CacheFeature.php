...
class ArulsIpCacheFeature extends ArulsIpBaseFeature
{
    ...
    private function _through(ArulsIpContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
class ArulsIpRatelimitFeature extends ArulsIpBaseFeature
{
    ...
    private function _acquire(ArulsIpContext $ctx): void
    {
    ...
    private function _track(ArulsIpContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

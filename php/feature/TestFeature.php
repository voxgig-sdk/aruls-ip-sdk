...
// ArulsIp SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ArulsIpTestFeature extends ArulsIpBaseFeature
{
    ...
    public function init(ArulsIpContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ArulsIpContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ArulsIpContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ArulsIpContext $ctx, $op, $args): array
    {

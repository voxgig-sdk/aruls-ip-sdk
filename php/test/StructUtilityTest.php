...
// ArulsIp SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ArulsIpOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ArulsIpOmni::structfix($now, Struct::undef()))
                        !== json_encode(ArulsIpOmni::structfix($val, Struct::undef()))) {

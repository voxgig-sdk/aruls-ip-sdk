...
// ArulsIp SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ArulsIpSDK::test)
...
{
    private const SDK_CLASS = 'ArulsIpSDK';
    ...
    private const SDK_BASE = 'arulsip_sdk';

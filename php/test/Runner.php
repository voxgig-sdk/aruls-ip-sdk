...
class ArulsIpTestRunner
{
    ...
    {
        $live = self::getenv('ARULS_IP_TEST_LIVE');
        $override = self::getenv('ARULS_IP_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ARULS_IP_TEST_EXPLAIN');
...
class_alias('ArulsIpTestRunner', 'Runner');
class_alias('ArulsIpHelpers', 'Helpers');

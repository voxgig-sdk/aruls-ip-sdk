...
class IpAddressEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ARULSIP_TEST_IP_ADDRESS_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ip_address_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ARULSIP_TEST_IP_ADDRESS_ENTID");

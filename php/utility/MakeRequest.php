...
// ArulsIp SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ArulsIpMakeRequest
{
    public static function call(ArulsIpContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ArulsIpResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ArulsIpResponse($fetched);
        } else {

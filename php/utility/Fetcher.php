...
// ArulsIp SDK utility: fetcher

class ArulsIpFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ArulsIpSDK/1.0)';
    ...
    public static function call(ArulsIpContext $ctx, string $fullurl, array $fetchdef): array
    {

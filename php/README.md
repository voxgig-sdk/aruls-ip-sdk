...
The PHP SDK for the ArulsIp API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->IpAddress(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->ArulsIp(null)->load(
    ["id" => "test01"], null
);
